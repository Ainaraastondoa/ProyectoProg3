...
public class Coche {
	...
	/**
	 * M�todo que calcula el n�mero cercano a 1 por el que tenemos que multiplicar el tiempo por vuelta seg�n la degradaci�n de
	 * las ruedas.
	 * @return El n�mero por el que multiplicar el tiempo por vuelta inicial
	 */
